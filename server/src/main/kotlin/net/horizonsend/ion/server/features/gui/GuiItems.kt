...
enum class GuiItem(val modelKey: Key) : ItemProvider {
	...
	BAL_10K(NamespacedKeys.packKey("achievement_icon/balance_10k")),
	BAL_50K(NamespacedKeys.packKey("achievement_icon/balance_50k")),
	BAL_100K(NamespacedKeys.packKey("achievement_icon/balance_100k")),
	BAL_500K(NamespacedKeys.packKey("achievement_icon/balance_500k")),
	BAL_1M(NamespacedKeys.packKey("achievement_icon/balance_1m")),
	BAL_5M(NamespacedKeys.packKey("achievement_icon/balance_5m")),
